...
import 'package:golf_app/Utils/Providers/UserProvider.dart';
...
class PlayerDetailsState extends State<PlayerDetails> {
  ...
  Widget build(BuildContext context) {
    return Container(
      padding: const EdgeInsets.only(left: 20.0, right: 20.0), //add left right padding
      ...
      child: Consumer<UserProvider> (builder: (context, provider, child) {
        return Column(
          ...
          children: [
            ...
            Text(provider.firstName, style: Theme.of(context).textTheme.headline2,),
            ...
            Expanded(
              child: Center(
                child: Column(
                  ...
                  children: [
                    Text('Handicap', style: Theme.of(context).textTheme.headline3,),
                    Text(provider.getHandicap().toString(), style: Theme.of(context).textTheme.headline1),
                    Text('Low:', style: Theme.of(context).textTheme.headline3,)
                  ],
                ),
              ),
            )
